// @generated by `make gen-palworld-types`. Do not edit by hand.
//
// Ported from PALWORLD_TYPE_HINTS in deafdudecomputers/PalworldSaveTools
// (https://github.com/deafdudecomputers/PalworldSaveTools, MIT).
// See src/palworld_types.rs for what consumes this table.

pub const PALWORLD_TYPE_HINTS: &[(&str, &str)] = &[
    (
